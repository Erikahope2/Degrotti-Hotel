...
<body style="background-color:#A87987;">
  ...
  <div>
    ...
    <label for="Velmachoice">Margherita Pizza - $</label>150
    <input type="number" value="1" min="1">
  </div>
  
  <div>
    <input type="checkbox" id="Davechoice" value="150$">
    <label for="Davechoice">Peperoni Pizza - $</label>150
    <input type="number" value="1" min="1">
  </div>
  
  <div>
    <input type="checkbox" id="Davechoice" value="175$">
    <label for="Davechoice">Spag Bol - $</label>175
    <input type="number" value="1" min="1">
  </div>
  
  <div>
    <input type="checkbox" id="Davechoice" value="175$">
    <label for="Davechoice">Pasta Fresca - $</label>175
    <input type="number" value="1" min="1">
  </div>
  ...
  <div>
    <input type="checkbox" id="uwueats" value="150$">
    <label for="Velmachoice">Coke - $</label>150
    <input type="number" value="1" min="1">
  </div>
  
  <div>
    <input type="checkbox" id="Davechoice" value="175$">
    <label for="Davechoice">Orange Smoothie - $</label>175
    <input type="number" value="1" min="1">
  </div>

   <div>
    <input type="checkbox" id="Davechoice" value="200$">
    <label for="Davechoice">Expresso - $</label>200
    <input type="number" value="1" min="1">
  </div>
  ...
  <div>
    ...
    <label for="Davechoice">Millionare Shortbread - $</label>125
    <input type="number" value="1" min="1">
  </div>

  <div>
    <input type="checkbox" id="Davechoice" value="125$">
    <label for="Davechoice">Chocolate Muffin - $</label>125
    <input type="number" value="1" min="1">
  </div>
  ...
  <div>
    ...
    <label for="Velmachoice">Double Down Danny- $</label>1600
    <input type="number" value="1" min="1">
  </div>
  ...
  <div>
    ...
    <label for="Davechoice">The Fat DeGrotti- $</label>5000
    <input type="number" value="1" min="1">
  </div>
  ...
  <h3>Espresso Specials</h3>
   ...
   <div>
    <input type="checkbox" id="Davechoice" value="2500$">
    <label for="Davechoice">20- Espressos - $</label>2500
    <input type="number" value="1" min="1">
  </div>

   <div>
    <input type="checkbox" id="Davechoice" value="3500$">
    <label for="Davechoice">30- Espressos - $</label>3500
    <input type="number" value="1" min="1">
  </div>

   <div>
    <input type="checkbox" id="Davechoice" value="4500$">
    <label for="Davechoice">40- Espressos - $</label>4500
    <input type="number" value="1" min="1">
  </div>

   <div>
    <input type="checkbox" id="Davechoice" value="5500$">
    <label for="Davechoice">50- Espressos - $</label>5500
    <input type="number" value="1" min="1">
  </div>

   <div>
    <input type="checkbox" id="Davechoice" value="9000$">
    <label for="Davechoice">100- Espressos - $</label>9000
    <input type="number" value="1" min="1">
  </div>

<h3>Smoothie Bundles</h3>

   <div>
    <input type="checkbox" id="Davechoice" value="4500$">
    <label for="Davechoice">32- Smoothies - $</label>4500
    <input type="number" value="1" min="1">
  </div>
